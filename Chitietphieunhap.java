...
class DANHSACH9 {
    ...
    public static void themds(int maphieunhap) {
		...
		newct2.setMachitietphieunhap(maphieunhap); // Gán maphieunhap cho machitietphieunhap
    ...
    public static void goi9() {
        DANHSACH9.codecung9(new chitiet9(1254, 125, 5, 100, 500));
        DANHSACH9.codecung9(new chitiet9(15421, 415, 3, 125, 375));
        DANHSACH9.codecung9(new chitiet9(9, 102, 5, 50, 250));
        DANHSACH9.codecung9(new chitiet9(20, 145, 7, 200, 1400));
        DANHSACH9.codecung9(new chitiet9(300, 115, 6, 375, 2250));
